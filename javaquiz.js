...
class JavaQuizGenerator {
    ...
    initializeQuestionBank() {
        return {
            multipleChoice: [
                {
                    question: "What keyword is used to declare a variable that can hold decimal numbers in Java?",
                    options: [
                        "int",
                        "float",
                        "string",
                    ...
                    correct: 1,
                    explanation: "The 'float' keyword is used to declare floating-point variables that can hold decimal numbers in Java.",
                    difficulty: "beginner"
                },
                {
                    ...
                    correct: 2,
                    explanation: "String is a reference data type, not a primitive data type. Primitive types in Java are: byte, short, int, long, float, double, boolean, and char.",
                    difficulty: "beginner"
                },
                {
            ...
            fillBlanks: [
                {
                    question: "The ________ keyword is used to create a subclass in Java.",
                    answer: "extends",
                ...
                {
                    question: "The ________ method is the entry point of a Java application.",
                    answer: "main",
            ...
            identification: [
                {
                    ...
                    answer: "final",
                    explanation: "The 'final' keyword is used to create constants that cannot be modified after initialization.",
                    difficulty: "beginner"
                },
                {
                ...
                },
                {
                    ...
                    answer: "false",
                    explanation: "Boolean variables have a default value of false in Java.",
                    difficulty: "beginner"
                },
                {
