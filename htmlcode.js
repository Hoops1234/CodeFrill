...
// Submit answer button for daily task
const submitAnswerBtn = document.getElementById('submitAnswer');
if (submitAnswerBtn) {
   submitAnswerBtn.addEventListener('click', submitDailyAnswer);
}
...
const videoQuizData = {
  ...
  'modalVideo2': [
    { time: 20, question: 'What is the correct HTML structure?', options: ['<html><head></head><body></body></html>', '<html><body></body><head></head></html>', '<head><html></html><body></body></head>', '<body><html></html><head></head></body>'], correct: 0, type: 'multiple' },
    { time: 45, question: 'Write an HTML paragraph tag with the text "Hello World":', type: 'code', correctCode: '<p>Hello World</p>', hints: ['Use the <p> tag', 'Put the text between opening and closing tags'] },
    { time: 75, question: 'Write an HTML link tag that links to "https://example.com" with text "Click here":', type: 'code', correctCode: '<a href="https://example.com">Click here</a>', hints: ['Use the <a> tag', 'Add href attribute with the URL', 'Put the link text between tags'] }
  ]
};
...
function loadQuizProgress() {
  const saved = localStorage.getItem('htmlhandout-quiz-progress');
  if (saved) {
    try {
...
function saveQuizProgress() {
  ...
  localStorage.setItem('htmlhandout-quiz-progress', JSON.stringify(data));
  
  // Update profile quiz results with aggregated HTML quiz score
  updateProfileQuizResults('HTML');
}
...
function updateProfileQuizResults(subject) {
  ...
  console.log('Profile quiz results updated - HTML video ' + videoId + ' score:', score + '%');
}
...
function updateQuizStatus() {
  ...
  if (video1Quizzes.length > 0) {
    statusHtml += '<div class="video-quiz-status"><strong>HTML Introduction:</strong>';
  ...
  // HTML Structure video quizzes
  const video2Quizzes = videoQuizData['modalVideo2'] || [];
  if (video2Quizzes.length > 0) {
    statusHtml += '<div class="video-quiz-status"><strong>HTML Structure:</strong>';
...
const DAILY_TASK_QUESTIONS = [
  {
    question: "What does HTML stand for?",
    keywords: ["hyper text markup language", "hypertext", "markup", "language"],
  ...
  },
  {
    ...
    keywords: ["document type", "html5", "version", "standard"],
    answer: "It declares the document type and HTML5 standard for the browser",
    explanation: "The <!DOCTYPE html> declaration tells the browser that this document is an HTML5 document, ensuring it renders in standards mode."
  },
  {
    question: "Which HTML element is used for the largest heading?",
    keywords: ["h1", "heading", "h1 tag"],
    answer: "<h1>",
    explanation: "The <h1> element defines the most important heading. HTML headings range from <h1> (most important) to <h6> (least important)."
  },
  {
    question: "What tag creates a paragraph in HTML?",
    keywords: ["p", "paragraph"],
    answer: "<p>",
    explanation: "The <p> tag defines a paragraph of text. Browsers automatically add some margin before and after each <p> element."
  },
  {
    question: "How do you create a hyperlink in HTML?",
    keywords: ["a", "href", "anchor", "link"],
    answer: "Using the <a href='url'>link text</a> tag",
    explanation: "The <a> tag (anchor tag) with the href attribute creates a hyperlink. The href specifies the URL the link goes to."
  },
  {
    question: "What are the two required attributes for the <img> tag?",
    keywords: ["src", "alt", "source", "alternative text"],
    answer: "src (image source) and alt (alternative text)",
    explanation: "The src attribute specifies the path to the image, while the alt attribute provides alternative text for accessibility and when the image cannot load."
  },
  {
    question: "What is the difference between <ul> and <ol> tags?",
    keywords: ["unordered", "ordered", "bullets", "numbers"],
    answer: "<ul> creates bullet lists, <ol> creates numbered lists",
    explanation: "<ul> defines an unordered (bulleted) list, while <ol> defines an ordered (numbered) list. Both use <li> for list items."
  },
  {
    question: "What does the <head> section contain?",
    keywords: ["metadata", "title", "stylesheets", "scripts"],
    answer: "Metadata about the document: title, stylesheets, scripts, etc.",
    explanation: "The <head> element contains meta-information about the document, such as the title, links to CSS, scripts, and other metadata."
  },
  {
    question: "Which tag sets the webpage title shown in the browser tab?",
    keywords: ["title"],
    answer: "<title>",
    explanation: "The <title> tag defines the title of the document, which appears in the browser's title bar or tab. It should be placed inside the <head> section."
  },
  {
    question: "What is the correct HTML element for inserting a line break?",
    keywords: ["br", "line break"],
    answer: "<br>",
    explanation: "The <br> tag inserts a single line break. It's an empty tag (no closing tag needed) and is used for line breaks in text."
  },
  {
    question: "What is the purpose of the id attribute in HTML?",
    keywords: ["unique identifier", "css selector", "javascript"],
    answer: "It provides a unique identifier for an element used in CSS and JavaScript",
    explanation: "The id attribute specifies a unique identifier for an HTML element, allowing it to be targeted by CSS or JavaScript via #id selector."
  },
  {
    question: "Which HTML element is used to create a table row?",
    keywords: ["tr"],
    answer: "<tr>",
    explanation: "The <tr> tag defines a row in an HTML table. Each row contains <td> (data cells) or <th> (header cells)."
  },
  {
    question: "What is the correct way to comment in HTML?",
    keywords: ["comment", "<!--"],
    answer: "<!-- This is an HTML comment -->",
    explanation: "HTML comments start with <!-- and end with -->. The content inside is not displayed in the browser."
  },
  {
    question: "What does the <meta charset='UTF-8'> tag do?",
    keywords: ["character encoding", "utf-8", "encoding"],
    answer: "It specifies the character encoding as UTF-8 for proper text display",
    explanation: "This meta tag declares the character encoding for the HTML document as UTF-8, ensuring characters display correctly across different browsers."
  },
  {
    question: "Which tag is used to define important text (typically displayed in bold)?",
    keywords: ["strong", "important"],
    answer: "<strong>",
    explanation: "The <strong> tag indicates that its content has strong importance, typically rendered in bold. It also conveys semantic importance for accessibility."
  }
];

const MS_PER_DAY = 24 * 60 * 60 * 1000;
const STORAGE_KEYS = {
  ANSWERS: 'dailyTaskAnswers-htmlhandout',
  SCORE: 'dailyTaskScore-htmlhandout',
  CURRENT_QUESTION: 'dailyTaskCurrentQuestion-htmlhandout',
  LAST_UPDATE: 'dailyTaskLastUpdate-htmlhandout'
};
...
function validateAnswer(userAnswer, questionData) {
  ...
  // For exact answer questions (like tag questions), check for exact match
  if (questionData.answer.startsWith('<')) {
    // For tag questions, require the user to include the exact tag
  ...
  // If only one keyword matched, it's likely not sufficient
  return false;
}
...
function submitDailyAnswer() {
   ...
   const oldFeedback = input.parentNode.querySelector('.answer-feedback, .correct-answer-box');
