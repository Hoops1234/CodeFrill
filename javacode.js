...
// Daily Questions Database (Java programming focused)
const dailyQuestions = [
  {
    question: "What does Java stand for?",
    type: "text",
    answer: "Java is not an acronym. It's a name inspired by Java coffee.",
    hint: "Java is named after coffee, not an acronym."
  },
  {
    question: "Write the Java keyword used to declare a class.",
    type: "code",
    answer: "class",
    hint: "It's a reserved word that defines a class."
  },
  {
    question: "What is the entry point of a Java program?",
    type: "text",
    answer: "main method",
    hint: "The JVM looks for this specific method signature."
  },
  {
    question: "Write the correct syntax for a Java main method.",
    type: "code",
    answer: "public static void main(String[] args)",
    hint: "It's a public static method that takes a String array."
  },
  {
    question: "Which data type is used for whole numbers in Java?",
    type: "text",
    answer: "int",
    hint: "It's a 32-bit signed integer."
  },
  {
    question: "Write a Java statement to declare an integer variable named 'count'.",
    type: "code",
    answer: "int count;",
    hint: "Use the int keyword followed by variable name."
  },
  {
    question: "What is the purpose of the 'new' keyword in Java?",
    type: "text",
    answer: "creates a new object",
    hint: "It allocates memory for an object."
  },
  {
    question: "Write the Java code to print 'Hello, World' to the console.",
    type: "code",
    answer: "System.out.println(\"Hello, World\");",
    hint: "Use System.out.println with the message in quotes."
  },
  {
  ...
  },
  {
    ...
    type: "text",
    answer: "0",
    hint: "Primitive numeric types default to zero."
  },
  {
    question: "Write an if statement that checks if x is equal to 10.",
    type: "code",
    answer: "if (x == 10) {",
    hint: "Use double equals for comparison, opening brace required."
  },
  {
  ...
  {
    question: "Write the Java statement to create a String variable named 'name'.",
    type: "code",
    answer: "String name;",
    hint: "String is a non-primitive type, starts with capital S."
  },
  {
    question: "What principle allows Java objects to have multiple forms?",
    type: "text",
    answer: "polymorphism",
    hint: "It's one of the four main OOP concepts."
  },
  {
    question: "Write the syntax to create an array of 5 integers.",
    type: "code",
    answer: "int[] arr = new int[5];",
    hint: "Use square brackets and the new keyword."
  },
  {
    question: "What keyword is used to inherit a class in Java?",
    type: "text",
    answer: "extends",
    hint: "It follows the class name in the subclass declaration."
  },
  {
    question: "Write a method that returns the sum of two integers.",
    type: "code",
    answer: "public int sum(int a, int b) { return a + b; }",
    hint: "Use public int return type, method name 'sum', two parameters."
  },
  {
    question: "What is the superclass of all Java classes?",
    type: "text",
    answer: "Object",
    hint: "It's in the java.lang package."
  },
  {
    question: "Write the correct way to create an ArrayList of Strings.",
    type: "code",
    answer: "ArrayList<String> list = new ArrayList<>();",
    hint: "Use angle brackets for generics, diamond operator."
  }
];

// Daily Task State Management
const DAILY_TASK_STORAGE_KEY = 'dailyTaskData-javacode';
...
// Video Quiz Functionality - Java Programming
const videoQuizData = {
  'modalVideo2': [
...
function loadQuizProgress() {
  const saved = localStorage.getItem('javacode-quiz-progress');
  if (saved) {
    try {
...
function saveQuizProgress() {
  ...
  localStorage.setItem('javacode-quiz-progress', JSON.stringify(data));
  
  // Update profile quiz results with aggregated Java quiz score
  updateProfileQuizResults('Java');
}

// Update the user profile's quizResults with Java quiz score (when a video is completed)
...
// Add timeupdate listener to Java video
document.querySelectorAll('#modalVideo2').forEach(video => {
  let previousTime = 0;
...
function updateQuizStatus() {
  ...
  const video1Quizzes = videoQuizData['modalVideo2'] || [];
    ...
    if (submitBtn) {
      submitBtn.addEventListener('click', () => {
        if (selectedIndex === null) {
          // Skip - mark as wrong
          markQuizAnswer(video.id, index, false);
        } else {
          const isCorrect = (selectedIndex === quiz.correct);
          markQuizAnswer(video.id, index, isCorrect, selectedIndex, quiz.correct);
        }
        // Remove overlay
        overlay.remove();
        // Resume video
    ...
    if (submitBtn && codeInput) {
      submitBtn.addEventListener('click', () => {
        ...
        if (!userCode) {
          ...
          const normalizedCorrectCode = quiz.correctCode.replace(/\s+/g, ' ').trim();
          const isCorrect = (normalizedUserCode === normalizedCorrectCode);
          markQuizAnswer(video.id, index, isCorrect);
        }
        // Remove overlay
        overlay.remove();
        // Resume video
...
// Mark quiz answer and update status
function markQuizAnswer(videoId, index, isCorrect, selectedIndex, correctIndex) {
  // Mark as answered with result
  if (!answeredQuizzes[videoId]) {
    answeredQuizzes[videoId] = [];
  }
