        ...
        return {
            multipleChoice: [
                ...
                },
                {
                    ...
                    correct: 0,
                    explanation: "The CSS box model consists of four parts: content, padding, border, and margin.",
                ...
                {
                    question: "What is the default display property value for div elements?",
                    options: [
                        "inline",
                        "block",
                        "inline-block",
                    ...
                    correct: 1,
                    explanation: "Div elements have a default display property of 'block', which means they take up the full width available.",
                    difficulty: "intermediate"
                },
                {
                ...
                {
                    question: "What does the CSS position property value 'absolute' do?",
                    options: [
                        "Positions relative to the viewport",
                        "Positions relative to the normal position",
                        "Positions relative to the nearest positioned ancestor",
                        "Removes the element from the document flow"
                    ],
                    correct: 2,
                    explanation: "When position is set to 'absolute', the element is positioned relative to its nearest positioned ancestor.",
                    difficulty: "intermediate"
                },
                {
                    ...
                    correct: 2,
                    explanation: "The 'visibility' property is used to control whether an element is visible or hidden.",
                    difficulty: "intermediate"
                },
                {
                ...
                },
                {
                    ...
                    correct: 2,
                    explanation: "Flexbox is a CSS layout module designed for laying out, aligning, and distributing space among items in a container.",
                    difficulty: "intermediate"
                },
                {
