        ...
        return {
            multipleChoice: [
                ...
                },
                {
                    ...
                    options: [
                        "It provides a unique identifier for an element",
                        "It specifies the language of the element",
                        "It assigns one or more class names to an element",
                        "It defines the title of the element"
                    ],
                    correct: 2,
                    explanation: "The class attribute assigns one or more class names to an element, allowing CSS styling and JavaScript targeting.",
                    difficulty: "beginner"
                },
                {
                    question: "Which attribute is used to provide a caption for a table?",
                    options: ["title", "caption", "summary", "label"],
                    correct: 2,
                    explanation: "The summary attribute provides a description of the table's purpose for screen readers and accessibility.",
                    difficulty: "intermediate"
                },
                {
                    question: "What does the 'id' attribute do in HTML?",
                ...
                {
                    question: "Which attribute is used to disable form input elements like <input>, <textarea>, and <button>?",
                    options: ["disabled", "readonly", "hidden", "inactive"],
                    correct: 0,
                    explanation: "The 'disabled' attribute makes form controls non-interactive and prevents user input, commonly used for form validation states.",
                    difficulty: "intermediate"
                },
                {
                    question: "What is the purpose of the 'lang' attribute in the <html> tag?",
