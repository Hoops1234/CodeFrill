    ...
    initializeQuestionBank() {
        return {
            multipleChoice: [
                ...
                {
                    question: "Which CSS selector would you use to target all elements with a specific class name?",
                    options: [
                        "#classname",
                        ".classname",
                        "*classname",
                    ...
                    correct: 1,
                    explanation: "The class selector uses a dot (.) followed by the class name to target all elements with that specific class attribute.",
                    difficulty: "beginner"
                },
                {
